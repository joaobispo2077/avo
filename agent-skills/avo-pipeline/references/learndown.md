...
**Durable state:** the approved-master record and learning-wrap artifact
...
**Stop when:** Missing required input, a failed or stale gate, a required human decision, or verified learndown completion
