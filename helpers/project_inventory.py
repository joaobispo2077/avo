...
try:
    from telemetry import dir_size
except ImportError:  # pragma: no cover - package-style import fallback
    from .telemetry import dir_size  # type: ignore

try:
    from session import diff_inventories as _session_diff_inventories
    from session import scan_inventory as _session_scan_inventory
except ImportError:
    try:
        from .session import diff_inventories as _session_diff_inventories  # type: ignore
        from .session import scan_inventory as _session_scan_inventory  # type: ignore
    except ImportError:
        _session_scan_inventory = None
        _session_diff_inventories = None
