...
**Skill:** [`docs/avo-pipeline/references/docs.md`](../../docs/avo-pipeline/references/docs.md)
...
2. Load path from docs router table in [`docs.md`](../../docs/avo-pipeline/references/docs.md).
