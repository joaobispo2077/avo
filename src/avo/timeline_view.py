...
Usage:
    python -m avo.timeline_view.py <video> <start> <end>
    python -m avo.timeline_view.py <video> <start> <end> -o out.png
    python -m avo.timeline_view.py <video> <start> <end> --n-frames 12
    python -m avo.timeline_view.py <video> <start> <end> --transcript <path>
    python -m avo.timeline_view.py --edl <edl.json>   (full-project view — not yet)
"""
