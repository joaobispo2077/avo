...
Usage:
    python -m avo.grade.py <input> -o <output>                   # auto mode
    python -m avo.grade.py <input> -o <output> --preset warm_cinematic
    python -m avo.grade.py <input> -o <output> --filter 'eq=contrast=1.1'
    python -m avo.grade.py --print-preset warm_cinematic         # print filter only
    python -m avo.grade.py --analyze <input>                     # print auto-grade analysis
