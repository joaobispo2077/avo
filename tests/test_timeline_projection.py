...
class TimelineProjectionTests(unittest.TestCase):
    def test_projection_preserves_order_and_marks_derived_lineage(self) -> None:
        artifact = {
            "artifactType": "cmap", "artifactId": "main", "currentRevisionId": "r1",
            "approvedRevisionId": "r1",
            "revisions": [{
                "revisionId": "r1", "contentHash": "a" * 64,
                "snapshot": {
                    "sources": [
                    ...
                    "segments": [
                        {"segmentId": "s2", "sourceId": "b", "in": {"ticks": 500, "timebase": {"num": 1, "den": 1000}}, "out": {"ticks": 1500, "timebase": {"num": 1, "den": 1000}}, "storySectionId": "middle"},
                        {"segmentId": "s1", "sourceId": "a", "in": {"ticks": 0, "timebase": {"num": 1, "den": 1000}}, "out": {"ticks": 2000, "timebase": {"num": 1, "den": 1000}}, "storySectionId": "end"},
                    ],
                },
            }],
        }
